"""
rails-e-commerce-1 - Backend API
...
app = FastAPI(
    title="rails-e-commerce-1",
    description="Rails E-Commerce 1: E-commerce store with Rails, Stripe, PostgreSQL, and Active Storage",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "rails-e-commerce-1"}
